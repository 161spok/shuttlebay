...
st.image('images/ragapp.png', caption='RAG app')
...
st.image('images/ragapp.png', caption='Flusso di preparazione dei dati per il recupero della generazione aumentata (RAG)')
